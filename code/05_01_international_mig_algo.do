...
drop _all
cd "$AFG_CDR"
use processed/VFD_restricted_1monthmin, clear
...
save processed/finalborders, replace //first pass identifies which is final border
...
merge m:1 id using processed/finalborders
...
save processed/dropouts, replace
...
use processed/dropouts, replace
drop _merge
...
*----------3.1:
merge 1:1 id date using processed/VFD_restricted_1monthmin
...
save processed/VFD_restricted_1monthmin_with_migration, replace
