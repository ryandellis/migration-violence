...
==================================================*/
do "_config.do"
use "$derived/VFD_restricted_1monthmin", clear
...
save "$derived/finalborders", replace //first pass identifies which is final border
...
merge m:1 id using "$derived/finalborders"
...
*----------3.1:
merge 1:1 id date using "$derived/VFD_restricted_1monthmin"
...
save "$derived/VFD_restricted_1monthmin_with_migration", replace
