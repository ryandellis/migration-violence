...
\begin{figure}[h]
    ...
    \includegraphics[width=0.8\linewidth]{unhcr_refugees_tsline.png}
    \vspace{0.25cm}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.8\linewidth]{SIGACTS_events.png}
...
\begin{figure}[h]
    ...
    \includegraphics[width=0.8\linewidth]{sigacts_actor.png}
    \vspace{0.25cm}
...
\begin{figure}[h]
    ...
    \includegraphics[width=0.8\linewidth]{sigacts_type.png}
    \vspace{0.25cm}
...
\begin{figure}[h]
    ...
    \includegraphics[width=0.8\textwidth]{afg_roshan_popdensity.png}
    \vspace{0.25cm}
...
\begin{table}[h]
    \centering
    \caption{5km exposures to violence, by individual user}       \input{sumstat5km1_1monthmin}
    \label{tab:sumstat}
    \vspace{.25cm}
...
\begin{figure}[h]
    ...
    \includegraphics[width=0.9\textwidth]{cog_example_jmp.png}
    \vspace{0.25cm}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=0.8\linewidth]{convex_hull.png}
    \vspace{0.25cm}
    \label{fig:boundary}
...
\begin{table}[htbp]
    ...
    \input{simple_logit_combo_ctrls}
...
\begin{figure}[h]
    \centering
        \caption{Marginal change in predicted log odds of external migration} \includegraphics[width=0.8\linewidth, height=8cm]{migration_levels_ctrls.png} 
        \vspace{0.25cm}
...
\begin{figure}[h]
        ...
        \includegraphics[width=0.8\linewidth, height=8cm]{nonmig_levels_ctrls.png}
        \vspace{0.25cm}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.8\linewidth, height=7.5cm]{migration_elasticities_ctrls.png}
    %\vspace{0.25cm}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.8\linewidth, height=7.5cm]{nonmig_elasticities_ctrls.png}
    %\vspace{0.25cm}
...
\includegraphics[width=\linewidth]{survival_combo.png}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.7\linewidth]{killbarslenient5km.png}
    \includegraphics[width=0.7\linewidth]{killbarslenient20km.png}
\vspace{0.25cm}
...
\begin{figure}[h]
    ...
    \includegraphics[width=0.8\textwidth]{imputed.png}
    \vspace{0.25cm}
...
\begin{table}[h]
    \centering
    \caption{Migration and high-casualty violence: 10+ wounded events}   \input{casualty_logit_combo_wtag}
    \vspace{0.25cm}
...
\begin{table}[h]
    \centering
    \caption{Migration and high-casualty violence: 10+ killed events}   \input{casualty_logit_combo_ktag}
    \vspace{0.25cm}
...
\begin{table}[h]
    \centering
    \caption{Migration and violence (Poisson)}   \input{simple_poisson_combo_ctrls}
    \vspace{0.25cm}
...
\begin{table}[h]
    ...
    \input{simple_probit_combo_ctrls}
    \vspace{0.25cm}
...
\begin{table}[h]
    \centering
    \caption{Migration and IED exposures}   \input{simple_logit_combo_ied}
    \vspace{0.25cm}
...
\begin{table}[h]
    \centering
    \caption{Do migrants experience more violence?}   \input{sanitycheck}
    \vspace{0.25cm}
...
\begin{table}[h]
    \centering
    \caption{Test of \cite{bohra-mishra_individual_2011}}   \input{quadtratic}
    \vspace{0.25cm}
